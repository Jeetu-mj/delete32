...
router.post('/insoverDetails',upload.single('file'), async(req,res)=>{
    console.log("inside Institute overview details function");
    console.log(req.file);
    // res.send('Image');
    const notifications = req.body.notifications || [];


    const overviewdata = new insoverDetails({
    ...
    try {
        ...
        console.log("Error in Adding Institute Overview Details",error);
    }
})
