...
const coldetails = require('../../models/Institute/General')
...
const storage = multer.diskStorage({
    ...
    filename: function (req, file, cb) {
        ...
        const filePath = path.resolve(__dirname, '../../../reactjs/public/InstituteLogos', uniqueSuffix + file.originalname);
...
router.put('/insgenupdatedetails/:colfull', multipleUpload, async (req, res) => {
    try {
        console.log("Inside Institute General Update Details")
